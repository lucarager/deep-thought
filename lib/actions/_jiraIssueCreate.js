...
module.exports = {
    regex: /^(?:deep-thought|deep_thought|Deep Thought|DT)(?: |,|:){1,2}(?:create a )([A-z]*)(?: priority )([A-z]*)(?: in )([A-z]*)(?:\:)([A-z]*)(?: for )([A-z]*)(?:\: )(.*)(?:\|)(.*)/ig,
    params: [
        'priority',
        'type',
        'version',
            ...
            if (body.length === 1) {
                ...
                jira.api.addNewIssue(issue, function(error, issue) {
                    if (error) {
                        ...
                        config.channel.send("I've successfully created the issue *"+issue.key+"* !");
                    }
                });
